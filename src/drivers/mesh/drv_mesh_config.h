...
#define BUFFER_OUTBOUND_PACKETS_SIZE 8
#define BUFFER_PER_PEER_PACKETS_SIZE 10
...
#define DISC_FRAC_START 8
#define DISC_FRAC_END 20
#define DISC_BACKOFF_DURATION_MS LIB_DATETIME__MS_IN_DAY/24
